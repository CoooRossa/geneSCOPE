...
.native_spatial_direct_guard <- function(entrypoint,
                                         disable_option = NULL) {
    ...
    if (identical(sysname, "darwin") &&
        ...
        stop(
            ...
            "Unset this option or set it to FALSE to use the native path.",
            call. = FALSE
        )
    }
...
grid_nb_omp <- function(nrow, ncol, queen = TRUE) {
    .native_spatial_direct_guard("grid_nb_omp", "geneSCOPE.disable_native_grid_nb")
    .Call(`_geneSCOPE_grid_nb_omp`, nrow, ncol, queen)
}

grid_nb_serial <- function(nrow, ncol, queen = TRUE) {
    .native_spatial_direct_guard("grid_nb_serial", "geneSCOPE.disable_native_grid_nb")
...
grid_nb_hex_omp <- function(nrow, ncol, oddr = TRUE) {
    .native_spatial_direct_guard("grid_nb_hex_omp", "geneSCOPE.disable_native_grid_nb")
    .Call(`_geneSCOPE_grid_nb_hex_omp`, nrow, ncol, oddr)
}

grid_nb_hex <- function(nrow, ncol, oddr = TRUE) {
    .native_spatial_direct_guard("grid_nb_hex", "geneSCOPE.disable_native_grid_nb")
...
grid_nb_hexq_omp <- function(nrow, ncol, oddq = TRUE) {
    .native_spatial_direct_guard("grid_nb_hexq_omp", "geneSCOPE.disable_native_grid_nb")
    .Call(`_geneSCOPE_grid_nb_hexq_omp`, nrow, ncol, oddq)
}

grid_nb_hexq <- function(nrow, ncol, oddq = TRUE) {
    .native_spatial_direct_guard("grid_nb_hexq", "geneSCOPE.disable_native_grid_nb")
...
listw_B_omp <- function(nb) {
    .native_spatial_direct_guard("listw_B_omp", "geneSCOPE.disable_native_listw_builder")
...
grid_weights_kernel_rect_omp <- function(nrow, ncol, gx, gy, queen = TRUE, radius = 2L, kernel = "gaussian", sigma = 1.0) {
    .native_spatial_direct_guard("grid_weights_kernel_rect_omp", "geneSCOPE.disable_native_kernel_weights")
...
grid_weights_kernel_hexr_omp <- function(nrow, ncol, gx, gy, oddr = TRUE, radius = 2L, kernel = "gaussian", sigma = 1.0) {
    .native_spatial_direct_guard("grid_weights_kernel_hexr_omp", "geneSCOPE.disable_native_kernel_weights")
...
grid_weights_kernel_hexq_omp <- function(nrow, ncol, gx, gy, oddq = TRUE, radius = 2L, kernel = "gaussian", sigma = 1.0) {
    .native_spatial_direct_guard("grid_weights_kernel_hexq_omp", "geneSCOPE.disable_native_kernel_weights")
...
grid_nb <- function(nrow, ncol, queen = TRUE) {
    .native_spatial_direct_guard("grid_nb", "geneSCOPE.disable_native_grid_nb")
    .Call(`_geneSCOPE_grid_nb`, nrow, ncol, queen)
}

nb2mat <- function(nb) {
    .native_spatial_direct_guard("nb2mat", "geneSCOPE.disable_native_listw_builder")
