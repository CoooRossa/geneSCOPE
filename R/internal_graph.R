...
#' @keywords internal
#' @param vertices Character vector of vertex identifiers.
#' @param edges_df Data frame of edges with columns `from` and `to`.
#' @param weights Numeric vector of edge weights aligned to `edges_df`.
