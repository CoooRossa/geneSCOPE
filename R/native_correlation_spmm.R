...
.spmm_dgc_dense <- function(X, W, n_threads = 1L, precision = c("float32", "float64")) {
    ...
    if (precision == "float32") {
        .Call(`_geneSCOPE_.spmm_dgc_dense_f32`, X, W, as.integer(n_threads), PACKAGE = "geneSCOPE")
    } else {
        .Call(`_geneSCOPE_.spmm_dgc_dense_f64`, X, W, as.integer(n_threads), PACKAGE = "geneSCOPE")
    }
}
